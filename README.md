...
This is for Node 1's lecture. Its use is to demonstrate sending data. There's no UI except a button. We'll use the devtools to see what's sent and the responses. Be sure to look in the code.
